...
const DemoHappned = () => {
  ...
  const { getLeadFollowUpAll, demoHappned, filtereddemoHappned, getLeadFollowUpFilter } = useContext(DataContext);
  ...
  const handleSelect = (date) => {
    ...
    getLeadFollowUpFilter("Demo Happened", date.selection.startDate, date.selection.endDate);
  ...
  useEffect(() => {
    getLeadFollowUpAll("Demo Happened");
  }, [])
  ...
  return (
    <>
      ...
      <div className='m-8'>
        ...
        {demoHappned ?
          isDemoDate ?
          demoHappned.length == 0 ? <NoDataPage status={"Demo Happned"} /> : null
            : null : null}

        {filtereddemoHappned ?
          !isDemoDate ?
          filtereddemoHappned.length == 0 ? <NoDataPage status={"Demo Happned"} /> : null
            : null : null}
