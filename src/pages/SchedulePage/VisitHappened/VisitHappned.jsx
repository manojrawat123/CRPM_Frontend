...
const VisitHappned = () => {
  ...
  const { getLeadFollowUpAll, visitHappned } = useContext(DataContext);
  const [isVisitDate, setIsVisitDate] = useState(true);
  const [filteredvisitHappned, setFilteredVisitSechudle] = useState([]);
  ...
  const handleSelect = (date) => {
    ...
    let filtered = visitHappned?.filter((product) => {
