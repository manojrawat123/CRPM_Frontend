...
const EmailShedule = () => {
  ...
  const emailTemplateFunc = () => {
    axios.get(`${API_BASE_URL}/emailtemplate/`, {
      headers: {
  ...
  return (
    <>
<EmailSheduleModal myProps={{modalIsOpen: modalIsOpen, 
  ...
  onChange={(e) => {
    ...
    console.log(tempObj);
    setFieldValue("templateBody", tempObj ? tempObj.TemplateBody : "");
    setFieldValue("templateSubject", tempObj ? tempObj.TemplateMessage : "");
...
<ErrorMessage name="template" component="div" className="text-red-500" />
            ...
            />
            <ErrorMessage name="templateSubject" component="p" className="text-red-600 text-sm" />
          </div>
