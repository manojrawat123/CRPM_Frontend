        ...
        <tr key={props.index}>
            ...
            <td className="border px-4 py-2">
                <button className="bg-red-500 text-white px-4 py-2 rounded"
                    type='button'
                    onClick={() => {
                        const newEmailContainer = props?.myEmailContainer?.filter((element2) => {
                            return props?.element.LeadEmail !== element2?.LeadEmail;
                        });
                        props?.setMyEmailContainer(newEmailContainer);
                    }}
                >
                    Remove
                </button>
        ...
        <tr  className={`${props.index % 2 == 0 ? `bg-[#f5f5dc]` : `bg-white`}  `}>
          ...
          <td className="border border-gray-300 px-4 py-2">
            ...
            <div className='grid grid-cols-5 gap-10'>
              ...
              <div className='col-span-3'>{props?.element?.LeadEmail}</div>
            </div>
            <div className='grid grid-cols-5 gap-10'>
